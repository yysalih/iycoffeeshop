...
import '../../repos/cake_repository.dart';
...
class BreakfastView extends ConsumerWidget {
  final String uid;
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final breakfastProvider = ref.watch(breakfastStreamProvider(uid));
    final userProvider = ref.watch(userStreamProvider(currentUserUid));


    return breakfastProvider.when(
      data: (breakfast) => Stack(
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Text(languages[language]![breakfast.name]!, style: kTitleTextStyle.copyWith(color: reverseTextColor(theme), fontSize: 20.w),),
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            Text(languages[language]![breakfast.description]!, style: kCustomTextStyle.copyWith(
                        ...
                        CustomSquaredButton(
                          ...
                          onPressed: () {
                            orderNotifier.addProductInBasket(breakfast, 1);
