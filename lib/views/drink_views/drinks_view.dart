        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              Text(languages[language]!["for_you"]!, style: kTitleTextStyle.copyWith(color: reverseTextColor(theme),
                  fontSize: 17.w),),
            ],
          ),
        ),
          ...
          child: Column(
            children: [
              Container(
                ...
                color: Colors.white,
                child: drinksProvider.when(
                  data: (drinks) => GridView.builder(
