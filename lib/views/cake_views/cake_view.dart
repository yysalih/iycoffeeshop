...
class CakeView extends ConsumerWidget {
  final String uid;
  const CakeView({super.key,
    required this.uid
  });
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final cakeProvider = ref.watch(cakeStreamProvider(uid));
    final userProvider = ref.watch(userStreamProvider(currentUserUid));


    return cakeProvider.when(
      data: (cake) => Stack(
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Text(languages[language]![cake.name]!, style: kTitleTextStyle.copyWith(color: reverseTextColor(theme), fontSize: 20.w),),
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            Text(languages[language]![cake.description]!, style: kCustomTextStyle.copyWith(
                        ...
                        CustomSquaredButton(
                          ...
                          onPressed: () {
                            orderNotifier.addProductInBasket(cake, 1);
